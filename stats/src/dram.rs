...
impl DRAM {
    ...
    #[must_use] pub fn new(num_total_cores: usize, num_mem_units: usize, num_banks: usize) -> Self {
        ...
        Self { bank_writes, bank_reads, total_bank_writes, total_bank_reads }
    }

    #[must_use] pub fn total_reads(&self) -> u64 {
        self.total_bank_reads.iter().flatten().sum()
    }

    #[must_use] pub fn total_writes(&self) -> u64 {
