...
{
    pub fn run_to_completion_parallel_nondeterministic(&mut self, n: u64) -> eyre::Result<()> {
        let mut cycle: u64 = 0;
        ...
        // let _core_worker_handles: Vec<_> = cores
        //     .into_iter()
        //     .map(|core| {
        //         let start_core_rx = start_core_rx.clone();
        //         let done_core_tx = done_core_tx.clone();
        //         std::thread::spawn(move || loop {
        //             if start_core_rx.recv().is_err() {
        //                 break;
        //             }
        //             core.write().unwrap().cycle();
        //             done_core_tx.send(()).unwrap();
        //         })
        //     })
        //     .collect();
        //
        ...
        //             start_core_tx.send(()).unwrap();
        //         }
        //
        //         // wait for all cores to finish
        //         for _ in 0..num_cores {
        //             done_core_rx.recv().unwrap();
        //         }
        //
        //         for cluster in &mut self.clusters {
