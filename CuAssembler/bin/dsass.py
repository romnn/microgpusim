...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        help="Input filename, can be dumped sass, cubin, or binary contains cubin.",
    )
    parser.add_argument(
        "-o",
        "--output",
        dest="outfile",
        help="Output filename, infered from input filename if not given.",
    )
    parser.add_argument(
        "-k",
        "--keepcode",
        action="store_true",
        help="Keep code-only lines in input sass, default to strip.",
    )
    parser.add_argument(
        "-n",
        "--nodeschack",
        action="store_true",
        help="Do not hack desc bit, no matter SM version it is.",
    )
    parser.add_argument(
        "-f",
        "--logfile",
        dest="logfile",
        help="File name for saving the logs, default to none.",
    )
