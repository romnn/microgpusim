...
class memory_config {
 public:
  ...
  void configure() {
    m_perf_sim_memcpy = 0;
    simple_dram_model = 0;
    scheduler_type = (dram_ctrl_t)0;
    gpgpu_L2_queue_config = 0;
    l2_ideal = 0;
    m_L2_config.m_config_string = 0;
    m_L2_texure_only = 0;
    m_n_mem = 0;
    m_n_sub_partition_per_memory_channel = 0;
    gpu_n_mem_per_ctrlr = 0;
    gpgpu_memlatency_stat = 0;
    gpgpu_frfcfs_dram_sched_queue_size = 0;
    gpgpu_dram_return_queue_size = 0;
    busW = 0;
    BL = 0;
    data_command_freq_ratio = 0;
    gpgpu_dram_timing_opt = 0;
    rop_latency = 0;
    dram_latency = 0;
    dual_bus_interface = 0;
    dram_bnk_indexing_policy = 0;
    dram_bnkgrp_indexing_policy = 0;
    seperate_write_queue_enabled = 0;
    write_queue_size_opt = 0;
    elimnate_rw_turnaround = 0;
    icnt_flit_size = 0;
    m_address_mapping.configure();
  }
