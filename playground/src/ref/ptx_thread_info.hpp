...
public:
  ...
  void init(trace_gpgpu_sim *gpu, trace_shader_core_ctx *core, unsigned sid,
            unsigned cta_id, unsigned wid, unsigned tid, bool fsim) {
    m_gpu = gpu;
    m_core = core;
    m_hw_sid = sid;
    m_hw_ctaid = cta_id;
  ...
  //  void set_operand_value(const operand_info &dst, const ptx_reg_t &data,
  //                         unsigned type, ptx_thread_info *thread,
  //                         const ptx_instruction *pI, int overflow, int
  //                         carry);
  //  void get_vector_operand_values(const operand_info &op, ptx_reg_t
  //  *ptx_regs,
  //                                 unsigned num_elements);
  //  void set_vector_operand_values(const operand_info &dst,
  //                                 const ptx_reg_t &data1, const ptx_reg_t
  //                                 &data2, const ptx_reg_t &data3, const
  //                                 ptx_reg_t &data4);
  //  void set_wmma_vector_operand_values(
  //      const operand_info &dst, const ptx_reg_t &data1, const ptx_reg_t
  //      &data2, const ptx_reg_t &data3, const ptx_reg_t &data4, const
  //      ptx_reg_t &data5, const ptx_reg_t &data6, const ptx_reg_t &data7,
  ...
  //  void callstack_push(unsigned npc, unsigned rpc, const symbol
  //  *return_var_src,
