...
pub struct SM {
    ...
    pub sm_active_warps_avg_per_active_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__active_warps_avg_per_active_cycle_pct")]
    pub sm_active_warps_avg_per_active_cycle_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__elapsed_cycles_avg")]
    pub sm_elapsed_cycles_avg: Option<Metric<Float>>,
    #[serde(rename = "sm__elapsed_cycles_sum")]
    pub sm_elapsed_cycles_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__active_cycles_avg")]
    pub sm_active_cycles_avg: Option<Metric<Float>>,
    #[serde(rename = "sm__active_cycles_sum")]
    pub sm_active_cycles_sum: Option<Metric<Float>>,

    // #[serde(rename = "sm__inst_executed_avg_per_active_cycle")]
    // pub sm_inst_executed_avg_per_active_cycle: Option<Metric<Float>>,
    // #[serde(rename = "sm__inst_executed_avg_per_elapsed_cycle")]
    // pub sm_inst_executed_avg_per_elapsed_cycle: Option<Metric<Float>>,
    // #[serde(rename = "sm__inst_executed_pipes_mem_per_active_cycle_sol_pct")]
    // pub sm_inst_executed_pipes_mem_per_active_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_issued_avg_per_active_cycle")]
    pub sm_inst_issued_avg_per_active_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_issued_per_active_cycle_sol_pct")]
    pub sm_inst_issued_per_active_cycle_sol_pct: Option<Metric<Float>>,

    // instructions executed
    #[serde(rename = "sm__inst_executed_avg")]
    pub sm_inst_executed_avg: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_avg_per_active_cycle")]
    pub sm_inst_executed_avg_per_active_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_avg_per_elapsed_cycle")]
    pub sm_inst_executed_avg_per_elapsed_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_max")]
    pub sm_inst_executed_max: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_min")]
    pub sm_inst_executed_min: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_per_active_cycle_sol_pct")]
    pub sm_inst_executed_per_active_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_per_elapsed_cycle_sol_pct")]
    pub sm_inst_executed_per_elapsed_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipes_mem_per_active_cycle_sol_pct")]
    pub sm_inst_executed_pipes_mem_per_active_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipes_mem_per_elapsed_cycle_sol_pct")]
    pub sm_inst_executed_pipes_mem_per_elapsed_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_sum")]
    pub sm_inst_executed_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_sum_per_active_cycle")]
    pub sm_inst_executed_sum_per_active_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_sum_per_elapsed_cycle")]
    pub sm_inst_executed_sum_per_elapsed_cycle: Option<Metric<Float>>,
    // instructions issued
    ...
    pub sm_maximum_warps_avg_per_active_cycle: Option<Metric<Float>>,
    #[serde(rename = "sm__maximum_warps_per_active_cycle_pct")]
    pub sm_maximum_warps_per_active_cycle_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_ld_bank_conflict_sum")]
    pub sm_shmem_ld_bank_conflict_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_ld_count_per_active_cycle_sol_pct")]
    pub sm_shmem_ld_count_per_active_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_ld_count_sum")]
    pub sm_shmem_ld_count_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_st_bank_conflict_sum")]
    pub sm_shmem_st_bank_conflict_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_st_count_per_active_cycle_sol_pct")]
    pub sm_shmem_st_count_per_active_cycle_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__shmem_st_count_sum")]
    pub sm_shmem_st_count_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sol_pct")]
    pub sm_sol_pct: Option<Metric<Float>>,
    #[serde(rename = "sm__warps_active.avg.pct_of_peak_sustained_active")]
    pub sm_warps_active_avg_pct_of_peak_sustained_active: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_alu_cycles_active.sum")]
    pub sm_pipe_alu_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_fma_cycles_active.sum")]
    pub sm_pipe_fma_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_fp64_cycles_active.sum")]
    pub sm_pipe_fp64_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_shared_cycles_active.sum")]
    pub sm_pipe_shared_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_tensor_cycles_active.sum")]
    pub sm_pipe_tensor_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__pipe_tensor_op_hmma_cycles_active.sum")]
    pub sm_pipe_tensor_op_hmma_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__cycles_elapsed.sum")]
    pub sm_cycles_elapsed_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__cycles_active.sum")]
    pub sm_cycles_active_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__cycles_active.avg")]
    pub sm_cycles_active_avg: Option<Metric<Float>>,
    #[serde(rename = "sm__cycles_elapsed.avg")]
    pub sm_cycles_elapsed_avg: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_integer_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_integer_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_ops_dadd_dmul_dfma_pred_on.sum")]
    pub sm_sass_thread_inst_executed_ops_dadd_dmul_dfma_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_ops_fadd_fmul_ffma_pred_on.sum")]
    pub sm_sass_thread_inst_executed_ops_fadd_fmul_ffma_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_ops_hadd_hmul_hfma_pred_on.sum")]
    pub sm_sass_thread_inst_executed_ops_hadd_hmul_hfma_pred_on_sum: Option<Metric<Float>>,

    #[serde(rename = "sm__inst_executed_pipe_alu.sum")]
    pub sm_inst_executed_pipe_alu_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_fma.sum")]
    pub sm_inst_executed_pipe_fma_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_fp16.sum")]
    pub sm_inst_executed_pipe_fp16_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_fp64.sum")]
    pub sm_inst_executed_pipe_fp64_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_tensor.sum")]
    pub sm_inst_executed_pipe_tensor_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_tex.sum")]
    pub sm_inst_executed_pipe_tex_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_xu.sum")]
    pub sm_inst_executed_pipe_xu_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__inst_executed_pipe_lsu.sum")]
    pub sm_inst_executed_pipe_lsu_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_fp16_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_fp16_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_fp32_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_fp32_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_fp64_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_fp64_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_dmul_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_dmul_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed_op_dfma_pred_on.sum")]
    pub sm_sass_thread_inst_executed_op_dfma_pred_on_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_thread_inst_executed.sum")]
    pub sm_sass_thread_inst_executed_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_shared_st.sum")]
    pub sm_sass_inst_executed_op_shared_st_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_shared_ld.sum")]
    pub sm_sass_inst_executed_op_shared_ld_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_memory_128b.sum")]
    pub sm_sass_inst_executed_op_memory_128b_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_memory_64b.sum")]
    pub sm_sass_inst_executed_op_memory_64b_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_memory_32b.sum")]
    pub sm_sass_inst_executed_op_memory_32b_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_memory_16b.sum")]
    pub sm_sass_inst_executed_op_memory_16b_sum: Option<Metric<Float>>,
    #[serde(rename = "sm__sass_inst_executed_op_memory_8b.sum")]
    pub sm_sass_inst_executed_op_memory_8b_sum: Option<Metric<Float>>,
}
