...
//     pub elapsed_cycles_sm: Option<String>,
//     pub inst_per_warp: Option<String>,
//     pub branch_efficiency: Option<String>,
//     pub warp_execution_efficiency: Option<String>,
//     pub warp_nonpred_execution_efficiency: Option<String>,
//     pub inst_replay_overhead: Option<String>,
//     pub shared_load_transactions_per_request: Option<f32>,
//     pub shared_store_transactions_per_request: Option<f32>,
//     pub local_load_transactions_per_request: Option<f32>,
//     pub local_store_transactions_per_request: Option<f32>,
//     pub gld_transactions_per_request: Option<f32>,
//     pub gst_transactions_per_request: Option<f32>,
//     pub shared_store_transactions: Option<usize>,
//     pub shared_load_transactions: Option<usize>,
//     pub local_load_transactions: Option<usize>,
//     pub local_store_transactions: Option<usize>,
//     pub gld_transactions: Option<usize>,
//     pub gst_transactions: Option<usize>,
//     pub sysmem_read_transactions: Option<usize>,
//     pub sysmem_write_transactions: Option<usize>,
//     pub l2_read_transactions: Option<usize>,
//     pub l2_write_transactions: Option<usize>,
//     pub global_hit_rate: Option<String>,
//     pub local_hit_rate: Option<String>,
//     pub gld_requested_throughput: Option<String>,
//     pub gst_requested_throughput: Option<String>,
//     pub gld_throughput: Option<String>,
//     pub gst_throughput: Option<String>,
//     pub local_memory_overhead: Option<String>,
//     pub tex_cache_hit_rate: Option<String>,
//     pub l2_tex_read_hit_rate: Option<String>,
//     pub l2_tex_write_hit_rate: Option<String>,
//     pub tex_cache_throughput: Option<String>,
//     pub l2_tex_read_throughput: Option<String>,
//     pub l2_tex_write_throughput: Option<String>,
//     pub l2_read_throughput: Option<String>,
//     pub l2_write_throughput: Option<String>,
//     pub sysmem_read_throughput: Option<String>,
//     pub sysmem_write_throughput: Option<String>,
//     pub local_load_throughput: Option<String>,
//     pub local_store_throughput: Option<String>,
//     pub shared_load_throughput: Option<String>,
//     pub shared_store_throughput: Option<String>,
//     pub gld_efficiency: Option<String>,
//     pub gst_efficiency: Option<String>,
//     pub tex_cache_transactions: Option<String>,
//     pub flop_count_dp: Option<String>,
//     pub flop_count_dp_add: Option<String>,
//     pub flop_count_dp_fma: Option<String>,
//     pub flop_count_dp_mul: Option<String>,
//     pub flop_count_sp: Option<String>,
//     pub flop_count_sp_add: Option<String>,
//     pub flop_count_sp_fma: Option<String>,
//     pub flop_count_sp_mul: Option<String>,
//     pub flop_count_sp_special: Option<String>,
//     pub inst_executed: Option<String>,
//     pub inst_issued: Option<String>,
//     pub sysmem_utilization: Option<String>,
//     pub stall_inst_fetch: Option<String>,
//     pub stall_exec_dependency: Option<String>,
//     pub stall_memory_dependency: Option<String>,
//     pub stall_texture: Option<String>,
//     pub stall_sync: Option<String>,
//     pub stall_other: Option<String>,
//     pub stall_constant_memory_dependency: Option<String>,
//     pub stall_pipe_busy: Option<String>,
//     pub shared_efficiency: Option<String>,
//     pub inst_fp_32: Option<String>,
//     pub inst_fp_64: Option<String>,
//     pub inst_integer: Option<String>,
//     pub inst_bit_convert: Option<String>,
//     pub inst_control: Option<String>,
//     pub inst_compute_ld_st: Option<String>,
//     pub inst_misc: Option<String>,
//     pub inst_inter_thread_communication: Option<String>,
//     pub issue_slots: Option<String>,
//     pub cf_issued: Option<String>,
//     pub cf_executed: Option<String>,
//     pub ldst_issued: Option<String>,
//     pub ldst_executed: Option<String>,
//     pub atomic_transactions: Option<usize>,
//     pub atomic_transactions_per_request: Option<f32>,
//     pub l2_atomic_throughput: Option<String>,
//     pub l2_atomic_transactions: Option<String>,
//     pub l2_tex_read_transactions: Option<String>,
//     pub stall_memory_throttle: Option<String>,
//     pub stall_not_selected: Option<String>,
//     pub l2_tex_write_transactions: Option<String>,
//     pub flop_count_hp: Option<String>,
//     pub flop_count_hp_add: Option<String>,
//     pub flop_count_hp_mul: Option<String>,
//     pub flop_count_hp_fma: Option<String>,
//     pub inst_fp_16: Option<String>,
//     pub sysmem_read_utilization: Option<String>,
//     pub sysmem_write_utilization: Option<String>,
//     pub pcie_total_data_transmitted: Option<String>,
//     pub pcie_total_data_received: Option<String>,
...
//     pub inst_executed_shared_atomics: Option<String>,
//     pub inst_executed_tex_ops: Option<String>,
//     pub l2_global_load_bytes: Option<usize>,
//     pub l2_local_load_bytes: Option<usize>,
//     pub l2_surface_load_bytes: Option<usize>,
//     pub l2_local_global_store_bytes: Option<usize>,
//     pub l2_global_reduction_bytes: Option<usize>,
//     pub l2_global_atomic_store_bytes: Option<usize>,
//     pub l2_surface_store_bytes: Option<usize>,
//     pub l2_surface_reduction_bytes: Option<usize>,
//     pub l2_surface_atomic_store_bytes: Option<usize>,
//     pub global_load_requests: Option<usize>,
//     pub local_load_requests: Option<usize>,
//     pub surface_load_requests: Option<usize>,
//     pub global_store_requests: Option<usize>,
//     pub local_store_requests: Option<usize>,
//     pub surface_store_requests: Option<usize>,
//     pub global_atomic_requests: Option<usize>,
//     pub global_reduction_requests: Option<usize>,
//     pub surface_atomic_requests: Option<usize>,
//     pub surface_reduction_requests: Option<usize>,
//     pub sysmem_read_bytes: Option<usize>,
//     pub sysmem_write_bytes: Option<usize>,
//     pub l2_tex_hit_rate: Option<String>,
//     pub texture_load_requests: Option<String>,
//     pub unique_warps_launched: Option<String>,
//     pub sm_efficiency: Option<String>,
...
//     pub flop_sp_efficiency: Option<String>,
//     pub flop_dp_efficiency: Option<String>,
//     pub dram_read_transactions: Option<usize>,
//     pub dram_write_transactions: Option<usize>,
//     pub dram_read_throughput: Option<f32>,
//     pub dram_write_throughput: Option<f32>,
//     pub dram_utilization: Option<String>,
//     pub half_precision_fu_utilization: Option<String>,
//     pub dram_write_bytes: Option<usize>,
//     pub ecc_transactions: Option<String>,
//     pub ecc_throughput: Option<String>,
//     pub dram_read_bytes: Option<usize>,
// }
